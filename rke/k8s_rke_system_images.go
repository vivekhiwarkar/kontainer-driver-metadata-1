...
func loadK8sRKESystemImages() map[string]v3.RKESystemImages {
	return map[string]v3.RKESystemImages{
		...
		"v1.20.16-rancher1-1": {
			...
			CertDownloader:            "rancher/rke-tools:v0.1.78",
			KubernetesServicesSidecar: "rancher/rke-tools:v0.1.78",
			KubeDNS:                   "rancher/mirrored-k8s-dns-node-cache:v1.15.10",
			DNSmasq:                   "rancher/mirrored-k8s-dns-dnsmasq-nanny:v1.15.10",
			KubeDNSSidecar:            "rancher/mirrored-k8s-dns-sidecar:v1.15.10",
			KubeDNSAutoscaler:         "rancher/mirrored-cluster-proportional-autoscaler:1.8.1",
			Flannel:                   "rancher/mirrored-coreos-flannel:v0.15.1-rancher1",
			FlannelCNI:                "rancher/flannel-cni:v0.3.0-rancher6",
			CalicoNode:                "rancher/mirrored-calico-node:v3.17.2",
			CalicoCNI:                 "rancher/mirrored-calico-cni:v3.17.2",
			CalicoControllers:         "rancher/mirrored-calico-kube-controllers:v3.17.2",
			...
			CanalCNI:                  "rancher/mirrored-calico-cni:v3.17.2",
			CanalControllers:          "rancher/mirrored-calico-kube-controllers:v3.17.2",
			CanalFlannel:              "rancher/mirrored-coreos-flannel:v0.13.0",
			CanalFlexVol:              "rancher/mirrored-calico-pod2daemon-flexvol:v3.17.2",
			WeaveNode:                 "weaveworks/weave-kube:2.8.1",
			WeaveCNI:                  "weaveworks/weave-npc:2.8.1",
			AciCniDeployContainer:     "noiro/cnideploy:5.1.1.0.1ae238a",
		...
		"v1.21.10-rancher1-1": {
			...
			CertDownloader:            "rancher/rke-tools:v0.1.78",
			KubernetesServicesSidecar: "rancher/rke-tools:v0.1.78",
			KubeDNS:                   "rancher/mirrored-k8s-dns-node-cache:v1.17.4",
			DNSmasq:                   "rancher/mirrored-k8s-dns-dnsmasq-nanny:v1.17.4",
			KubeDNSSidecar:            "rancher/mirrored-k8s-dns-sidecar:v1.17.4",
			KubeDNSAutoscaler:         "rancher/mirrored-cluster-proportional-autoscaler:1.8.3",
			Flannel:                   "rancher/mirrored-coreos-flannel:v0.15.1",
			FlannelCNI:                "rancher/flannel-cni:v0.3.0-rancher6",
			CalicoNode:                "rancher/mirrored-calico-node:v3.19.1",
			CalicoCNI:                 "rancher/mirrored-calico-cni:v3.19.1",
			CalicoControllers:         "rancher/mirrored-calico-kube-controllers:v3.19.1",
			CalicoCtl:                 "rancher/mirrored-calico-ctl:v3.19.1",
			CalicoFlexVol:             "rancher/mirrored-calico-pod2daemon-flexvol:v3.19.1",
			CanalNode:                 "rancher/mirrored-calico-node:v3.19.1",
			CanalCNI:                  "rancher/mirrored-calico-cni:v3.19.1",
			CanalControllers:          "rancher/mirrored-calico-kube-controllers:v3.19.1",
			CanalFlannel:              "rancher/mirrored-coreos-flannel:v0.15.1",
			CanalFlexVol:              "rancher/mirrored-calico-pod2daemon-flexvol:v3.19.1",
			WeaveNode:                 "weaveworks/weave-kube:2.8.1",
			WeaveCNI:                  "weaveworks/weave-npc:2.8.1",
			AciCniDeployContainer:     "noiro/cnideploy:5.1.1.0.1ae238a",
			AciHostContainer:          "noiro/aci-containers-host:5.1.1.0.1ae238a",
